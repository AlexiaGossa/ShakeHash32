...
HashInfo g_hashes[] =
{
  ...
  { md5_64,               64, 0x5B6A13DF, "md5_64a",     "MD5, first 64 bits of result" },
  { sha1_32a,             32, 0xF9376EA7, "sha1_32a",    "SHA1, first 32 bits of result" },
  { sha1_64a,             64, 0x9030E249, "sha1_64a",    "SHA1, first 64 bits of result" },
  ...
  { CityHash32_test,      32, 0xC7CFD3F9, "City32",      "Google CityHash128WithSeed, first 32 bits of result" },
  ...
  { ShakeHash32,          32, 0x7D2CA223, "ShakeHash32", "ShakeHash32" },
...
{
  const char * hashToTest = "FNV"; //"murmur3a";
  //const char * hashToTest = "City32"; //"murmur3a";
  //const char * hashToTest = "sha1_32a";
  //const char * hashToTest = "md5_32a";
  if(argc < 2)
  {
